...
class TestMLR extends Thread{
    ...
    public static void main(String[] args) throws FileNotFoundException, IOException {
        ...
        //JAVA CODE HERE
        //==============
        FeatureNormalizationValues f = LogisticRegression.featureNormalize(X);
        X = insertX0(f.X);
        //==============
        ...
        Matrix theta = new Matrix(X.getColumnDimension(),1);
        Matrix J_history = new Matrix(LogisticRegression.num_iters,1);
        
        GradientDescentValues g = LogisticRegression.gradientDescent(X, y, theta, LogisticRegression.alpha, LogisticRegression.num_iters);
        theta = g.getTheta();
        ...
        theta = LogisticRegression.normalEqn(X, y);
